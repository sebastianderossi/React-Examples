...
##Granify software developer task

### Assignment Part 1:

[![N|Solid](https://github.com/sebastianderossi/React-Examples/blob/master/granify/granify.gif)](https://vimeo.com/286561117)

*Click image above to see it in action.*

**Video has been password protected**
...
+ Delete Record
+ Display Record
+ Somewhere on the page, make a statistics display area with these two statistics:
